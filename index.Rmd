...
Since the Las Vegas Shooting in 2017 is an immense outlier, a more accurate representation of the victim counts may be to find the median of each shooting type:
```{r}
...
knitr::kable(median_victim_count,
              col.names = c("Shooting Type",
                            "Average Total Victims"))
```
Still, there is typically a greater number of victims in non-school shootings.
