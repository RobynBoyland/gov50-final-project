...
df <- read_csv("data/Mass Shootings Dataset Ver 5.csv", show_col_types = FALSE) |>
  janitor::clean_names()
...
ggplot(data = df, aes(x =fatalities, y = injured)) +
  geom_point()
```
